...
const slides = [
  ...
  { id: 2, img: "/slider/keyboard_tray.png", imgheight: 400, bg: "/slider/bg-2.jpg", offer: "NEW SEASON ARRIVAL", text: "Keyboard tray", circleColor: "#F08A58", description: "A keyboard tray is a sliding platform mounted under a desk, designed to hold a keyboard and mouse, improving ergonomics and saving workspace on the desktop.", number: "02" },
