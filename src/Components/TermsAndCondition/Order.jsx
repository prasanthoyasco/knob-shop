...
<div class="section">
  ...
  ("We" or "Our" or "Us", wherever applicable) on the Knobsshop.store (the website). These
  conditions signify your agreement to be bound by these conditions.</p>

  <p>In addition, when you use any current or future Knobsshop.store (e.g.: Wishlist or
...
<div class="section">
  ...
  <p>Your order is an offer to us to buy the product(s) in your order. When you place an order to
  purchase a product from us, you will receive an e-mail confirming receipt of your order and
  containing the details of your order(the "OrderConfirmation E-mail"). The OrderConfirmation
  ...
  Confirmation E-mail"). If your order is dispatched in more than one package, you may receive
  a separate Dispatch Confirmation E-mail for each package, and each Dispatch Confirmation
  E-mail and corresponding dispatch will conclude a
  separate contract of sale between you and us for the product(s) specified in that Dispatch
  Confirmation E-mail.
  </p>

  <p>Your contract is with us (the Sellers) and you confirm that the product(s) ordered by you are
  ...
  <p>You can cancel your order for a product at no cost any time before we send the Dispatch
  Confirmation E-mail relating to that product</p>

  <p>Please note that we sell products only in quantities which correspond to the typical needs of an
  ...
  quantity typical for a normal household.</p>
</div>

<div class="section">
  <h2>2) Returns</h2>
  <p>Most items purchased from sellers listed on Knobsshop.store are returnable within the return
  window, except those that are explicitly identified as not returnable. The return is processed
  only if:
  </p>
  <ul>
  ...
  <p>You can review return policy for products listed on Knobsshop.store by clicking here (https://
  Knobsshop.store For the products that are returned by the customer, the refund is issued to the
  original payment method (in case of pre-paid transactions) or to the bank account / as
  Knobsshop Pay balance (in case of Pay on Delivery orders), the details for making such refund
  and the timelines are detailed in the refund policy available here https://www.knobsshop.store</a>
  </p>
