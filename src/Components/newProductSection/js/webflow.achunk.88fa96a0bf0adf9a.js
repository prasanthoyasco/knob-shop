    ...
    7199: function (t) {
      var e = window.jQuery,
        ...
        a = {
          ...
          intro: function (t, n) {
            n.__wf_intro ||
              ((n.__wf_intro = !0), e(n).triggerHandler(r.types.INTRO));
          },
          outro: function (t, n) {
            n.__wf_intro &&
              ((n.__wf_intro = null), e(n).triggerHandler(r.types.OUTRO));
          },
        };
      (r.triggers = {}),
      ...
      n.define(
        ...
        (t.exports = function (t) {
          ...
          function m(e, r) {
            var n = t.data(r, f);
            n &&
              (n.links && n.links.each(p.reset),
              n.panes && n.panes.each(p.reset));
          }
          function k(e, n) {
            var i = f.substr(1) + "-" + e,
              a = t(n),
            ...
            if (
                ...
                o.links.on(
                  ...
                  function (t) {
                    ...
                    if (n in i) {
                      t.preventDefault();
                      var a = i[n];
                      -1 === a && (a = p.links.length - 1),
                        a === p.links.length && (a = 0);
              ...
              var s,
                ...
                g,
                p,
                v = o.links.filter("." + w).attr(d);
              v && y(o, { tab: v, immediate: !0 });
            }
          }
          function y(e, r) {
            r = r || {};
            ...
            if (u !== e.current) {
              ...
              e.panes.each(function (e, r) {
                ...
                r.getAttribute(d) === u
                  ? l.push(r)
                  : n.hasClass(g) && f.push(r);
              });
              var h = t(l),
                b = t(f);
              if (r.immediate || a.immediate) {
                h.addClass(g).each(p.intro),
                  b.removeClass(g),
                  v || n.redraw.up();
                return;
              }
