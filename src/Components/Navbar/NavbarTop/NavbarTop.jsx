...
function NavbarTop() {
  ...
  const offers = [
    <>
      Welcome Bonus! Use{" "}
      <strong style={{ color: "#E18436" }}>KNOBSSHOP25</strong> on your first
      login & grab{" "}
      <strong style={{ color: "#E18436" }}>₹100 off instantly</strong>
    </>,
    <>
      Welcome Bonus! Use{" "}
      <strong style={{ color: "#E18436" }}>KNOBSSHOP25</strong> on your first
    ...
    <>
      ...
      <div className="navbar-top-container">
        ...
        <div className="navbar-top-offer">
          <p>
            Welcome Bonus! Use
            <strong style={{ color: "#E18436" }}> KNOBSSHOP25 </strong> on your
            first login & grab{" "}
            <strong style={{ color: "#E18436" }}> ₹100 off instantly </strong>
          </p>
        </div>
